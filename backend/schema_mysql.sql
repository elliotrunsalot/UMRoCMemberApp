...
INSERT IGNORE INTO users (id, email, password, first_name, surname, nickname, role, dob, gender, address, mobile, emergency_contact_name, emergency_contact_mobile, umnum, perm_race_num, race_history, awards, join_date, avatar)
VALUES
...
INSERT IGNORE INTO events (id, title, event_date, description, rsvps)
VALUES
